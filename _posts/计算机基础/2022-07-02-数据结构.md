...
<img src="../assets/xfx1k.gif" alt="img" style="zoom: 50%;" />
...
2. 最小窗口：[76.最小覆盖子串](https://leetcode.cn/problems/minimum-window-substring/)：包含`Target`所有字符的、当前字符串`Source`的最短子串；
   ...
   - **步骤**：十分**经典**的 `HashMap` 代码
      ...
      2. 寻找可行解：先不断增加 `right` 指针扩大窗口 `[left, right)`，直到窗口中的字符串符合要求（包含了 `T` 中所有字符）；
...
- [169.求众数：出现次数大于 n/2 的元素](https://leetcode.cn/problems/majority-element/)【】
  ...
  <img src="../assets/8wyb2.gif" alt="img" style="zoom: 50%;" />
...
<img src="../assets/y1l6o3nhel.png" alt="img"  />
