...
> 摘要：Spring + Spring MVC + Mybatis。Spring 框架包括 IoC 和 AOP，事务，设计模式等。Spring MVC，包括 MVC、Java Web。Spring Boot 包括配置、自动装配、数据库等。Spring Boot 整合 Web、Hibernate、MyBatis、Redis、ELK、Swagger-UI、Security、Hutool 等。
...
<img src="assets/f599114dd06c6a14afe9f64a5396f9de.png" alt="img" style="zoom:50%;" />
...
3. `Elasticsearch`：用于**存储**收集到的日志信息；以及生成索引数据，便于Kibana做检索。
